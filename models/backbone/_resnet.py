...
class ResNet(nn.Layer):
    ...
    Args:
        ...
        num_classes (int, optional): Output axis of last fc layer. If num_classes <= 0, last fc layer 
    ...
    def __init__(self,
        ...
        self._norm_layer = kwargs["norm_layer"]
        self.r_s_w_d = kwargs["replace_stride_with_dilation"]
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2, dilate=self.r_s_w_d[0])
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2, dilate=self.r_s_w_d[1])
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2, dilate=self.r_s_w_d[2])
        if with_pool:
