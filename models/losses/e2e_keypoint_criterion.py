...
class FixedMatcher(nn.Layer):
    def __init__(self, args):
        super().__init__()
        self.matcher_train = paddle.load(args.fix_match_train)
        self.matcher_val = paddle.load(args.fix_match_val)
...
class KeypointSetCriterion(nn.Layer):
    ...
    def loss_bce(self, outputs, targets, indices, num_boxes, num_pts):
        ...
        # valid_src_flag = paddle.ones_like(src_logits)
        ...
        weight_matrix = paddle.full_like(src_logits, self.bce_negative_weight)
