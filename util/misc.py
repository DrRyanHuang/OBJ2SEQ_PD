...
def nested_tensor_from_tensor_list(tensor_list: List[Tensor], fix_input=None, input_divisor=None):
    ...
    if tensor_list[0].ndim == 3:
        ...
        for id_, (img, pad_img, m) in enumerate(zip(tensor_list, tensor, mask)):
            ...
            tensor[id_, : img.shape[0], : img.shape[1], : img.shape[2]] = img 
            mask[id_, : img.shape[1], :img.shape[2]] = 0
...
if __name__ == "__main__":
    tensor_list = [paddle.rand(shape=(3, 234, 234)), 
                   paddle.rand(shape=(3, 254, 254))] 
...
def init_distributed_mode(args):
    if args.rank > -1:
        ...
        os.environ['LOCAL_SIZE'] = str(paddle.cuda.device_count())
        ...
        num_gpus = paddle.cuda.device_count()
    ...
    paddle.cuda.set_device(args.gpu)
