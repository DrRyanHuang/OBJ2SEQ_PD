...
# ------------------------------------------------------------------------
# Modified from codes in paddle.utils.data.distributed
# ------------------------------------------------------------------------
    ...
    def __iter__(self):
        if self.shuffle:
            ...
            if self.split_length is None:
                ...
                indices = []
                # sub_indices = [paddle.randperm(l, generator=g).tolist() for l in self.split_length]
                sub_indices = [np.random.permutation(l).tolist() for l in self.split_length]
