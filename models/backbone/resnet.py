...
class IntermediateLayerGetter(nn.LayerDict):
    """
    # https://github.com/PaddlePaddle/Paddle/pull/47908
    ...
    Additionally, it is only able to query sublayer that are directly
    ...
    Examples::
        ...
        >>> new_m = IntermediateLayerGetter(m,
...
class FrozenBatchNorm2d(nn.Layer):
    ...
    def __init__(self, n, eps=1e-5):
        ...
        # TODO difference between `self.create_tensor` and `paddle.ones`
        # self.create_tensor
